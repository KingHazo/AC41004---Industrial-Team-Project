...
<body>
            ...
            <ul class="nav-list">
                <?php if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] === true): ?>
                    <?php if ($_SESSION['userType'] === 'investor'): ?>
                        <li><a class="nav-links" href="<?= $base_url ?>/investor_portal/investor_portal_home.php">Discover</a>
                        </li>
                        <li><a class="nav-links" href="<?= $base_url ?>/investor_portal/investor_dashboard.php">My Portfolio</a>
                        </li>
                        <li><a class="nav-links" href="<?= $base_url ?>/investor_portal/investor_profile.php">My Account</a>
                        </li>
                        <li><a class="nav-links" href="<?= $base_url ?>/login/logout.php">Logout</a></li>
                    <?php elseif ($_SESSION['userType'] === 'business'): ?>
                        <li><a class="nav-links" href="<?= $base_url ?>/business_portal/business_dashboard.php">Dashboard</a>
                        </li>
                        <li><a class="nav-links" href="<?= $base_url ?>/business_portal/create_pitch.php">Create Pitch</a></li>
                        <li><a class="nav-links" href="<?= $base_url ?>/business_portal/business_profile.php">My Account</a>
                        </li>
                        <li><a class="nav-links" href="<?= $base_url ?>/login/logout.php">Logout</a></li>
                    <?php endif; ?>
                <?php else: ?>
    ...
    <!--to change the colour of the nav links if the hamburger menu is toggled-->
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            hamburger.addEventListener('click', () => {
                ...
                console.log('Navbar toggled. isOpen =', isOpen);

                // Fire custom event globally
